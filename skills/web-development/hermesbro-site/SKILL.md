...
**PITFALL — Business context first**: When working on the multitenant backend, ALWAYS study the business plan at `{{HERMES_HOME}}/hermes-bots-business-plan.md` and the monetization plan at `<HERMES_ROOT>/plans/monetizzazione-hermesbro.md` BEFORE proposing technical changes.
